...
public class CircleImageGenerator implements ImageGenerator {
    private final static Logger LOGGER = LoggerFactory.getLogger(CircleImageGenerator.class.getName());
    ...
    public CircleImageGenerator(int tilesPerRow, int tilesPerColumn, int maxReuses, int reuseDistance, List<Integer> areaOfInterest, IndexManager[] indexManagers) {
